              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
				...
				<c:forEach items="${listUsers}" var="User"  >
      				<tr>
		         		...
		         		<td>${User.getStateUser()}</td>
		         		<td>${User.getUserPass()}</td>
		         		<td>${User.getPhoneNumber()}</td>
		         		<td><a href="Them_SuaUser?UserCanSua=${User.getUserID() }&&temp=${Users.getUserID() }">
		         		
		         		Edit
		                   
		         		</td>
						<td><a href="XoaUser?UserCanXoa=${User.getUserID() }&&temp=${Users.getUserID() }">Delete</td>
         			</tr>
      		</c:forEach>
