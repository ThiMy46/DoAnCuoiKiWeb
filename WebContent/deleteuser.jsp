        ...
        <div class="right_col" role="main">
          <div class="">
           ...
           <div class="row" >
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
               ...
               <th><input type="checkbox" id="check-all" class="flat"></th>
                         ...
                         <td>GV1</td>
                          <td >**********</td>
                          <td> Nguyễn Thị Yến Vi</td>
                          <td>sandykio@gmail.com</td>
                          <td>02/12/1997</td>
                          <td>Teacher</td>
                        </tr>
                        <tr>
              <td>
               ...
               <th><input type="checkbox" id="check-all" class="flat"></th>
                          ...
                          <td >**********</td>
                          <td> Nguyễn Dương Văn Khoa</td>
                          <td>khoakhung123@gmail.com</td>
                          <td>30/04/1997</td>
                          <td>Admin</td>
                        </tr>
           ...
           <div class="modal-footer">
                       ...
                       <a href="deleteuser.jsp"><button type="button" class="btn btn-primary">Xoá</button></a> 
                      </div>
        </div>
        <!-- /page content -->
