             ...
             <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="DisplayResult"><i class="fa fa-envira"></i>Điểm các môn<span class="fa fa-chevron-down"></span></a>
					
                  </li>
                              
                   <li><a href="adminllv.html"><i class="fa fa-calendar"></i> Lịch làm việc </a>
                  ...
                  <div class="x_content" >
                   ...
                   <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="DangNhap" method="post">
                      ...
                      <div class="form-group">
                         <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Đã đổi pass thành công<span class="required">*</span>
                        </label>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                         ...
                         <input type="submit" style="float:right;margin:15px 50px 10px 0px;">
