              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel" class="responsive">
                  ...
                  <div class="x_content">
                   ...
                   <p>Click chọn câu hỏi cần thêm vào bài thi</p>
<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="XuLyCauHoi?temp=${Users.getUserID() }" method="post">
      		...
      		<c:forEach items="${questions}" var="question"  >
      				<tr class="even pointer">
      				 <td class="a-center ">
                              <input type="checkbox" class="flat" name="${question.getQuestionID()}" value="${question.getQuestionID()}"/>
                            </td>
		         		<td class=" ">${question.getQuestionID()}</td>
		         		<td class=" ">${question.getQuestionContent()}</td>
		         		<td class=" ">${question.getOptionA()}</td>
		         		<td class=" ">${question.getOptionB()}</td>
		         		<td class=" ">${question.getOptionC()}</td>
		         		<td class=" ">${question.getOptionD()}</td>
		         		<td class=" ">${question.getAnswer()}</td>
         			</tr>
      		</c:forEach>
      		</tbody>
                      </table>
        ...
        <footer>
          <div class="pull-right">
            Design NDK<a href="https://www.facebook.com/sandykio.zih"></a>
          </div>
          <div class="clearfix"></div>
            <div class="pull-right"> <a href="https://colorlib.com">Colorlib</a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
