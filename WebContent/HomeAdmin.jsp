                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-cog"></i> Quản Lí tài khoản<span class="fa fa-chevron-down"></span></a>
                   ...
                   <li><a><i class="fa fa-folder-open"></i> Quản lí đề thi<span class="fa fa-chevron-down"></span></a>
                    ...
                    <li><a><i class="fa fa-folder-open"></i> Quản Lí Câu Hỏi<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                   ...
                   <li><a><i class="fa fa-folder-open"></i> Quản Lí Ngành,Môn<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="DisplayMajor?temp=${Users.getUserID() }">Danh sách Ngành</a></li>
                      <li><a href="ThemQuestionJSP?temp=${Users.getUserID() }">Thêm Ngành</a></li>
                      <li><a href="DisplaySubject?temp=${Users.getUserID() }">Danh sách Môn</a></li>
                      <li><a href="ThemQuestionJSP?temp=${Users.getUserID() }">Thêm Môn</a></li>
                    </ul>
                  </li>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel" class="responsive">
                  ...
                  <div class="x_content" >
					...
					<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="DangNhap" method="post">
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">User ID:<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input value="${Users.getUserID() } "disabled type="text" name="UserID" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input value="${Users.getUserName() } "disabled type="text" name="UserName" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                       <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">DateOfBirth <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input value="${Users.getDateOfBirth()} "disabled type="text" name="DateOfBirth" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                       <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">PhoneNumber<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input value="${Users.getPhoneNumber() } "disabled type="text" name="PhoneNumber" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                    </form>                   
                  </div>
