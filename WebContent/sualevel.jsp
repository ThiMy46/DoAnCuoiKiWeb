      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="col-md-5 col-sm-5 col-xs-12 col-md-offset-1">
                          <button type="submit" class="btn btn-primary"data-toggle="modal"data-target="#myModal3">Sửa cấp độ</button>
                <!-- Modal --> 
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Sửa cấp độ</h4>
                      </div>
                      <div class="modal-body">
                        <form id="FormTimKiemNangCao" method="post" class="form-horizontal" action="">

                      <div class="form-group">
                        <label class="col-sm-4 control-label" for="TimKiemTheo">Mã cấp độ</label>
                        <div class="col-sm-5">
                          <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-4 control-label" for="TimKiemTheo">Tên bài thi</label>
                        <div class="col-sm-5">
                          <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label class="col-sm-4 control-label" for="TimKiemTheo">độ khó</label>
                        <div class="col-sm-5">
                          <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                                            <div class="form-group">
                        <label class="col-sm-4 control-label" for="TimKiemTheo">Thời gian làm bài</label>
                        <div class="col-sm-5">
                          <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                                            <div class="form-group">
                        <label class="col-sm-4 control-label" for="TimKiemTheo">Số lượng câu</label>
                        <div class="col-sm-5">
                          <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                       ...
                       <a href="sualevel.jsp"><button type="button" class="btn btn-primary">Lưu</button></a> 
                      </div>
                                        </div>
                                      </div>
                                    </div>
