...
<html lang="en">
  ...
  <body class="nav-md">
          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              ...
              <div class="profile_info" >
                <span style="margin-left: 10px; font-size:13px;">${Users.getUserName() }</span>
	...
	<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="SuaUser?UserCanSua=${user.getUserID() }&&temp=${Users.getUserID() }" method="post">
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">UserID: <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input value="${user.getUserID()}"  type="text" name="UserID" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input value="${user.getUserName() }"  name="UserName" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input value="${user.getUserPass() }" required="required" class="form-control col-md-7 col-xs-12"  name="UserPass">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input value="${user.getDateOfBirth()}" required="required" class="form-control col-md-7 col-xs-12"  name="DateOfBirth">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input value="${user.getStateUser()}" required="required" class="form-control col-md-7 col-xs-12"  name="StateUser">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input value="${user.getPhoneNumber()}" required="required" class="form-control col-md-7 col-xs-12"  name="PhoneNumber">
                        </div>
                      </div>
			<div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input value="${user.getGender()}" required="required" class="form-control col-md-7 col-xs-12"  name="Gender">
                        </div>
                      </div>
                      <div class="form-group">
          ...
          <div class="col-md-5 col-sm-5 col-xs-12 col-md-offset-1">
                          <button type="submit" class="btn btn-primary"data-toggle="modal"data-target="#myModal3">Sửa người dùng</button>
                <!-- Modal --> 
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Sửa Người dùng</h4>
                      </div>
                      <div class="modal-body">
                        <form id="FormTimKiemNangCao" method="post" class="form-horizontal" action="">

                      <div class="form-group">
                        <label class="col-sm-4 control-label" for="TimKiemTheo">Username</label>
                        <div class="col-sm-5">
                          <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-4 control-label" for="TimKiemTheo">Password</label>
                        <div class="col-sm-5">
                          <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label class="col-sm-4 control-label" for="TimKiemTheo">Tên người dùng</label>
                        <div class="col-sm-5">
                          <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                                            <div class="form-group">
                        <label class="col-sm-4 control-label" for="TimKiemTheo">Mail</label>
                        <div class="col-sm-5">
                          <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                                            <div class="form-group">
                        <label class="col-sm-4 control-label" for="TimKiemTheo">SĐT</label>
                        <div class="col-sm-5">
                          <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                                            <div class="form-group">
                        <label class="col-sm-4 control-label" for="TimKiemTheo">Quyền</label>
                        <div class="col-sm-5">
                          <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                       ...
                       <a href="deleteuser.jsp"><button type="button" class="btn btn-primary">Lưu</button></a> 
                      </div>
                                        </div>
                                      </div>
                                    </div>
