...
<html lang="en">
  ...
  <body class="nav-md">
        ...
        <div class="right_col" role="main">
          <div class="">
           ...
           <div class="modal-footer">
                       ...
                       <a href="deletelevel.jsp"><button type="button" class="btn btn-primary">Xoá</button></a> 
                      </div>
        </div>
        <!-- /page content -->
   ...
   <script src="vendors/jquery/dist/jquery.min.js"></script>
    ...
    <script src="vendors/datatables.net-buttons/js/buttons.html.min.js"></script>
