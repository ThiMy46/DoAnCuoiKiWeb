              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
				...
				<c:forEach items="${subjectss}" var="subject"  >
      				<tr>
		         		...
		         		<td>${subject.getMajorID()}</td>
		         		
		         		<td><a href="DisplayExamChoStudent?subjectid=${subject.getSubjectID()}&temp=${Users.getUserID()}" style="color:red">Bắt Đầu</td>
         			</tr>
      		</c:forEach>
