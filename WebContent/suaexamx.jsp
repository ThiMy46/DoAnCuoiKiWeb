      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
           ...
           <div class="row" >
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
               ...
               <th><input type="checkbox" id="check-all" class="flat"></th>
                          ...
                          <td>30/10/2017</td>
                          <td>02/11/2017</td>
                          <td><button type="button" class="btn btn-info btn-xs">Chưa hoàn thành</button></td>
                        </tr>
                        <tr>
                         <td>
               <th><input type="checkbox" id="check-all" class="flat"></th>
              ...
              <td>
                 <th><input type="checkbox" id="check-all" class="flat"></th>
                          ...
                          <td>10/10/2017</td>
                          <td>20/10/201</td>
                          <td> <button type="button" class="btn btn-success btn-xs">Đã hoàn thành</button></td>
                        </tr>
          ...
          <div class="col-md-5 col-sm-5 col-xs-12 col-md-offset-1">
                          <button type="submit" class="btn btn-primary"data-toggle="modal"data-target="#myModal3">Sửa bài kiểm tra</button>
                <!-- Modal --> 
